= accum
:description: KfuseQL accum search operator
:sectanchors: 
:url-repo:  
:page-tags: KfuseQL, Search Query Language, search operators, search, accum
:figure-caption!:
:table-caption!:
:example-caption!:
...
Another option is to find a running total for each user's requests. Running a query similar to:
